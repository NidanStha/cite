...
<head>
  <title>NSS | Completed Programs</title>
  <meta charset="UTF-8">
    ...
    <div class="container">
      <div class="row">
        <div class="completed">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 completed__left">
                <h3>Completed Programs</h3> </div>
              <div class="col-sm-6 completed__right"> <a href="../index.php">HOME</a> | Completed Programs </div>
            </div>
            <hr class="completed__hr">
          </div>
          <div class="completed__textcontents">
            Extra-Curriculum activities program had done in different 25 schools in Sindhuli by organization.
            <ul class="dashed">
              <li>Quality education improvement plan survey of 25 school of Sindhuli by organization.</li>
              <li>Sanitation and School health program by organization.</li>
              <li>Child right program (Child club and child clubnetwork formation) and child right training supported by DDO Sindhuli.</li>
              <li>Mosquito awareness program in Dhadauli, ladhavirsirthauli VDCS and Bhiman area is organized by ASHMAN Nepal manpower is managed by IRDP Sindhuli.</li>
            </ul>
            ...
            <ul>
              ...
              <li>Planning effective delivery education for future federal state by UNESCO.</li>
              <li>PFA(psycho-socio First Aids) ,monsoon preparedness and back to school training for social and health teachers of four resource Centre(167 schools) of Sindhuli supported by UNICEF through Restless Development country office Kathmandu Nepal</li>
              <li>Workshop on ’counseling  for adolescent girls and young women’supported by UNESCO Nepal.</li>
              <li>14 temporary toilets are constructed in emergency phase.</li>
              <li>Wash kits distribution in 20 schools.</li>
              <li>Educational kits distribution in187 schools.</li>
            </ul>
          </div>
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="../images/completed/1.jpg" alt="">
              <div class="caption">
                <h4 class="text-center">Education improvement</h4>
              </div>
            </div>
          </div>
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="../images/completed/2.jpg" alt="">
              <div class="caption">
                <h4 class="text-center">Water supply</h4>
              </div>
            </div>
          </div>
          <div class="col-xs-18 col-sm-6 col-md-4">
            <div class="thumbnail">
              <img src="../images/completed/3.jpeg" alt="">
              <div class="caption">
                <h4 class="text-center">Distribution for earthquake victim</h4>
              </div>
            </div>
          </div>
          <?php
            $qry = "SELECT * FROM tb_project where Pcondition='completed'";
            $res = $con->query($qry);
